...
import { ClienteI, CxcOperacionI, Tipo_CorreoI } from 'src/app/Modelos/response.interface';
...
export class CreditosComponent implements OnInit {
  ...
  ActualizaEstado(elemento: CxcOperacionI) {
    ...
    this.api.PutCxcOperacion(elemento).subscribe((x) => this.ListarElementos(1));
  }
  ...
  ClienteForms = new FormGroup({
    ...
    cli_genero: new FormControl('', Validators.required),
  ...
  GuardarObjetoCliente(datos: any) {
    ...
    datos.cli_fecha_nacimiento =
      datos.cli_fecha_nacimiento == '' ? minDate : datos.cli_fecha_nacimiento;
    datos.cli_fecha_fallecido =
      datos.cli_fecha_fallecido == '' ? minDate : datos.cli_fecha_fallecido;
    ...
    datos.cli_baseactual =
      datos.cli_baseactual.toString() === 'true' ? '1' : '0';
