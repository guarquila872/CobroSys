...
@Component({
  selector: 'app-costos-operacionales',
  templateUrl: './costos-operacionales.component.html',
  styleUrls: ['./costos-operacionales.component.css']
})
export class CostosOperacionalesComponent implements OnInit {
  constructor(
  ...
  PaginaActual: ResultadoMenuI = this.MenuAcceso.find((elemento) => {
    return elemento.men_url === 'costosoperacionales';
}) as ResultadoMenuI;
