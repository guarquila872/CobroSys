...
export class GestionarComponent implements OnInit {
  ...
  GestionForms = new FormGroup(
    {
      ...
      gest_id_tipo_gestion: new FormControl(0, [
        Validators.required,
        this.validar.ValidatorDeNumeros(),
      ]),
      ...
      gest_id_contacto: new FormControl(0, [
        Validators.required,
        this.validar.NumerosDiferenteDeCero(),
      ]),
      ...
      gest_valor_comp: new FormControl('', [
        this.validar.SoloNumerosDesimalesValidator(),
      ]),
      gest_abonos: new FormControl('', [
        this.validar.SoloNumerosDesimalesValidator(),
      ]),
      gest_num_coutas: new FormControl('', [this.validar.ValidatorDeNumeros()]),
      gest_num_coutas_res: new FormControl('', [
        this.validar.ValidatorDeNumeros(),
      ]),
      gest_couta: new FormControl('', [
        this.validar.SoloNumerosDesimalesValidator(),
      ]),
  ...
  ResetGestionFormsNoContactado() {
    ...
    this.GestionForms.patchValue({
      id_gestion: 0,
      gest_id_tipo_gestion: 1,
      gest_id_conectividad: 3,
      gest_id_contactabilidad: 1,
      gest_id_contacto: 0,
      gest_num_contacto: '',
  ...
  ObtenerValoresDePagos() {    
    ...
    let division = ((valorTotal/this.ProductoSeleccionado.ope_saldo_cxc_actual)*100).toFixed(2);    
  ...
  Operadora: any[] = [
    ...
    { id: 4, name: 'TWENTII', value: 'TWENTII' },
