...
export class AuthInterceptorService implements HttpInterceptor {
  ...
  //         console.log(err.status)
  //         Swal.fire('No se Encuentra Informacion Relacionada');
  //       }
  //       if([0].indexOf(err.status)!==-1){
  //         console.log(err)
  //         console.log('Problema de Coneccion a la Base')
  //         Swal.fire('No es Posible Acceder a la Informacion del Servidor');
  //       }
  //       const error=err.error.message||err.etatusText;
